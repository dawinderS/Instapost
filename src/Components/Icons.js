...
export const CompassLoc = ({ size = 22 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    fill="#262626"
  >
    <path d="M24 0C10.8 0 0 10.8 0 24s10.8 24 24 24 24-10.8 24-24S37.2 0 24 0zm12.2 13.8l-7 14.8c-.1.3-.4.6-.7.7l-14.8 7c-.2.1-.4.1-.6.1-.4 0-.8-.2-1.1-.4-.4-.4-.6-1.1-.3-1.7l7-14.8c.1-.3.4-.6.7-.7l14.8-7c.6-.3 1.3-.2 1.7.3.5.4.6 1.1.3 1.7zm-15 7.4l-5 10.5 10.5-5-5.5-5.5z" />
  </svg>
);
...
export const UploadLoc = ({ size = 24 }) => (
  <svg
    width={size}
    height={size}
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    ...
    <path fill="#fff" d="M13 2v9h9v2h-9v9h-2v-9h-9v-2h9v-9h2zm2-2h-6v9h-9v6h9v9h6v-9h9v-6h-9v-9z" />
...
export const FollowUsers = ({ size = 24 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const CancelButton = ({ size = 24 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const MessagingIcon = ({ size = 22 }) => (
  <svg
    fill="#262626" 
    viewBox="0 0 48 48" 
    height={size} 
...
export const MessagingIconLoc = ({ size = 22 }) => (
  <svg
    fill="#262626" 
    viewBox="0 0 48 48" 
    height={size} 
...
export const MultiView = ({ size = 22, fill = "#262626" }) => (
  <svg 
    fill={fill} 
    width={size}
    height={size}
...
export const SingleView = ({ size = 24, fill = "#262626" }) => (
  <svg 
    fill={fill}
    width={size} 
    height={size}
...
export const MessagingLogo = ({ size = 24 }) => (
  <svg
    fill="#262626"
    height={size}
    width={size}
...
export const LocationLogo = ({ size = 24 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
